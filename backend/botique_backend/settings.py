...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'access_control.context_processors.staff_permissions',
            ],
        },
    },
]
...
BULK_IMPORT_MAX_ZIP_BYTES = int(os.getenv('BULK_IMPORT_MAX_ZIP_BYTES', 100 * 1024 * 1024))
BULK_IMPORT_MAX_EXTRACTED_BYTES = int(os.getenv('BULK_IMPORT_MAX_EXTRACTED_BYTES', 500 * 1024 * 1024))
BULK_IMPORT_MAX_ENTRY_BYTES = int(os.getenv('BULK_IMPORT_MAX_ENTRY_BYTES', 25 * 1024 * 1024))
BULK_IMPORT_MAX_IMAGE_BYTES = int(os.getenv('BULK_IMPORT_MAX_IMAGE_BYTES', 10 * 1024 * 1024))
BULK_IMPORT_MAX_IMAGE_DIMENSION = int(os.getenv('BULK_IMPORT_MAX_IMAGE_DIMENSION', 8000))
BULK_IMPORT_MAX_IMAGE_PIXELS = int(os.getenv('BULK_IMPORT_MAX_IMAGE_PIXELS', 40_000_000))
BULK_IMPORT_MAX_IMAGES = int(os.getenv('BULK_IMPORT_MAX_IMAGES', 10000))
BULK_IMPORT_MAX_ROWS = int(os.getenv('BULK_IMPORT_MAX_ROWS', 10000))
BULK_IMPORT_MAX_PATH_DEPTH = int(os.getenv('BULK_IMPORT_MAX_PATH_DEPTH', 12))

...
AUDIT_ACTIONS = (
    ...
    # Promotion lifecycle (backend-written).
    "promotion_created",
    "promotion_updated",
    "promotion_activated",
    "promotion_deactivated",
    "promotion_deleted",
    "promotion_code_changed",
    "promotion_redeemed",
    "promotion_redemption_failed",
...
CATEGORY_BY_ACTION = {
    ...
    "promotion_created": "orders",
    "promotion_updated": "orders",
    "promotion_activated": "orders",
    "promotion_deactivated": "orders",
    "promotion_deleted": "orders",
    "promotion_code_changed": "orders",
    "promotion_redeemed": "orders",
    "promotion_redemption_failed": "orders",
    "promotion_usage_limit_reached": "orders",
    "role_created": "roles",
    "role_updated": "roles",
    "role_deleted": "roles",
...
SEVERITY_BY_ACTION = {
    ...
    "promotion_deleted": "medium",
    "promotion_deactivated": "medium",
    "role_created": "medium",
    "role_updated": "medium",
    "role_deleted": "high",

      ...
      <div className="w-full">
        ...
        <div className="relative">
          ...
          <input
            ...
            className={cn(
              "w-full bg-[#FFFFFF] border rounded-xl px-3.5 py-2.5 text-sm text-[#181716] placeholder-[#A29E96] transition-all duration-200 focus:outline-none focus:ring-1",
              error
    ...
    return (
      <div className="w-full">
        ...
        <textarea
          ...
          className={cn(
            "w-full bg-[#FFFFFF] border rounded-xl px-3.5 py-2.5 text-sm text-[#181716] placeholder-[#A29E96] transition-all duration-200 focus:outline-none focus:ring-1 resize-y min-h-[100px]",
            error
              ? "border-[#9E332B] focus:border-[#9E332B] focus:ring-[#9E332B] bg-[#FDF2F2]"
              : "border-[#E8E5DF] focus:border-[#A2574F] focus:ring-[#A2574F] hover:border-[#D8D3CB]",
            className
      ...
      <div className="w-full">
        ...
        <div className="relative">
          <select
            ...
            className={cn(
              "w-full bg-[#FFFFFF] border rounded-xl px-3.5 py-2.5 pr-10 text-sm text-[#181716] transition-all duration-200 focus:outline-none focus:ring-1 appearance-none cursor-pointer",
              error
                ? "border-[#9E332B] focus:border-[#9E332B] focus:ring-[#9E332B] bg-[#FDF2F2]"
                : "border-[#E8E5DF] focus:border-[#A2574F] focus:ring-[#A2574F] hover:border-[#D8D3CB]",
              className
